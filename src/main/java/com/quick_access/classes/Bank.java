...
import com.quick_access.interfaces.IBank;
...
public class Bank implements IBank {
    ...
    @Override
    public boolean addCustomerTransaction(String branchName, String customerName, double tramsaction) {
        if(findBranch(branchName) != null){
            return findBranch(branchName).addCustomerTransaction(customerName, tramsaction);
        }
        else return false;
    }
